...
let allStories = [
  ...
  },
  {
    ...
    story:
      "1 Once, there was a boy who became bored when he watched over the village sheep grazing on the hillside. To entertain himself, he sang out, “Wolf! Wolf! The wolf is chasing the sheep!”",
    moral:
      "1 Lying breaks trust — even if you’re telling the truth, no one believes a liar.",
  },
  {
    imageSource: "https://i.ytimg.com/vi/bzMyNQx2VA8/maxresdefault.jpg",
    title: "2 Moral Stories for Kids",
    story:
      "2 Once, there was a boy who became bored when he watched over the village sheep grazing on the hillside. To entertain himself, he sang out, “Wolf! Wolf! The wolf is chasing the sheep!”",
    moral:
      "2 Lying breaks trust — even if you’re telling the truth, no one believes a liar.",
  },
];
...
function CurrentStory() {
  ...
  const backStory = () => {
    ...
    if (currentStoryIndexClone < 0) setCurrentStoryIndex(2);
    else setCurrentStoryIndex(currentStoryIndexClone);
  };
  ...
  return (
    <div>
      ...
      />
      <button onClick={backStory}>Back</button>
